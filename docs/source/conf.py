...
# Determine repository root using pathlib for clarity and correctness.
here = Path(__file__).resolve().parent
repo = here.parent.parent
_version_py = repo / "nbsphinx_link" / "_version.py"
version_ns = {}
_version_text = _version_py.read_text(encoding="utf8")
exec(_version_text, {}, version_ns)

# The short X.Y version.
version = f"{version_ns['version_info'][0]}.{version_ns['version_info'][1]}"
...
man_pages = [(master_doc, "nbsphinx-link", "nbsphinx-link Documentation", [author], 1)]
